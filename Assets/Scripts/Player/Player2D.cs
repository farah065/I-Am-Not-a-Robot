...
public class Player2D : Singleton<Player2D>
{
    ...
    {
        MusicController.Instance.PlayShootSfx();
    ...
    public void TakeDamage()
    {
        if (Hp > 0)
        {
            ...
            {
                MusicController.Instance.PlayHurtSfx();
            }
        }
    }
    ...
    private IEnumerator Die()
    {
        ...
        _deathEffect.Play();
        MusicController.Instance.PlayGameOverSfx();
        MusicController.Instance.FadeOutBattleMusic();
